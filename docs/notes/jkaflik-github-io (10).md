[Skip to content](https://jkaflik.github.io/OpenMowerNext/clion-env.html#VPContent)

On this page

# Almost Devcontainer in CLion [​](https://jkaflik.github.io/OpenMowerNext/clion-env.html\#almost-devcontainer-in-clion)

## Overview [​](https://jkaflik.github.io/OpenMowerNext/clion-env.html\#overview)
...
## Prerequisites [​](https://jkaflik.github.io/OpenMowerNext/clion-env.html\#prerequisites)

- [Docker](https://docs.docker.com/get-docker/)
- [CLion](https://www.jetbrains.com/clion/download/) \+ extra [Docker plugin](https://plugins.jetbrains.com/plugin/7724-docker)

## Getting Started [​](https://jkaflik.github.io/OpenMowerNext/clion-env.html\#getting-started)
...
Please see [detailed information on containers](https://jkaflik.github.io/OpenMowerNext/devcontainer.html#detailed).